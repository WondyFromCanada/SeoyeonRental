...
public class UtilController {
	...
	**/
	...
	public String ckEnrollPage(HttpServletRequest request, Model model,
			HttpServletResponse response) {
		if(request.getParameter("divsn") != null) {
			String divsn = request.getParameter("divsn");
			logger.info("divsn : "  + divsn);
			
			model.addAttribute("divsn", divsn );
			response.reset();
		}
