			...
			<div class="col-md-8">
				<div class="">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select class="form-control" id="sellYn"
								name="sellYn" style="margin-bottom: 20px;">
				...
				<div style="float: right;">
					<button type="button" class="btn btn-default" onclick="location.href='adminProdExpdMgmtPage.do'">취소</button>
